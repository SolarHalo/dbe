<?php /* Smarty version Smarty-3.1.13, created on 2013-03-20 10:53:21
...
<div id="loged" style="visibility:visible;margin-top:5px;height:30px;"><?php echo $_smarty_tpl->tpl_vars['username']->value;?>
&nbsp;欢迎您&nbsp;|&nbsp;<a href="logout.php">退出</a></div>
<?php }else{ ?>
<div id="login" style="visibility:visible;margin-top:5px;height:30px;"><a href="login.php">登录</a>&nbsp;&nbsp;<a href="register.php">注册</a></div>
<?php }?><?php }} ?>