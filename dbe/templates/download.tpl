        ...
        <div class="container" id="container">
            ...
            <ul class="dow">
            	<li>
                	...
                	<a href="download.php?fileName=FA-DF-712U_jpg.pdf" {{if $loged=='N'}}onclick="alert('请先登录');window.location.href='login.php';return false;"{{/if}}>点击下载</a>
                </li>
                <li>
                	<img src="images/d2.png" />
                	<a href="download.php?fileName=FA-DR-640R_jpg.pdf" {{if $loged=='N'}}onclick="alert('请先登录');window.location.href='login.php';return false;"{{/if}}>点击下载</a>
                </li>
            </ul>
        </div>
